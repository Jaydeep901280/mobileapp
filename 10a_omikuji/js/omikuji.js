...
btn1.addEventListener("click",
    function () {
        ...
        //         btn1.style.fontSize = "40";
        //         break;
        //     case 1:
        //         btn1.textContent = "Happy!!";
        //         btn1.style.color = "#fff001";
        //         btn1.style.fontSize = "30";
        //         break;
        //     case 2:
       ...
       btn1.style.transition = "1s";
        ...
        let resultFonSize = ["90px", "80px", "70px", "60px", "50px", "40px",]  ;
        let resultMaxSpeed = [10, 10, 8, 5, 5, 5];
        let resultMaxSize = [30, 30, 20, 15, 20, 20 ];
        /*let n = Math.floor(Math.random() * resultText.length);
        btn1.textContent = resultText[n];
        btn1.style.color = resultColor[n];
        btn1.style.fontSize =resultFonSize[n];*/
 ...
 let resultSound =[
  ...
  omikujiText.style.fontSize = resultFonSize[n];
